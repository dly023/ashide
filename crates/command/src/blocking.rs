...
impl Command {
    ...
    pub fn new<S: AsRef<OsStr>>(program: S) -> Command {
        ...
        #[cfg(windows)]
        {
            ...
            // the process to the same Job Object as the Ashide process, otherwise the
            // process will be killed when the Ashide process is killed.
    ...
    /// The latter is needed to avoid a console window temporarily popping up in Ashide.
    ///
