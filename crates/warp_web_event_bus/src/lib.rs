...
/// Events emitted from Ashide on Web to the host JavaScript app.
///
/// These must stay in sync with the web client `WarpEvent` TypeScript type.
...
mod ffi {
    ...
    extern "C" {
        ...
        ///
        /// If we need to support more complicated embeddings (like having multiple Ashide Web instances
