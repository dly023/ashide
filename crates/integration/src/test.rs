...
use warp::{
    integration_testing::local_drive::{
        assert_is_left_panel_open, assert_local_drive_is_closed, assert_local_drive_is_open,
    },
    ...
    new_builder()
        ...
        .with_steps(
            open_command_palette_and_run_action("Create a New Team Folder")
                .add_assertion(assert_local_drive_is_closed()),
        )
        .with_steps(
        ...
        .with_steps(
            open_command_palette_and_run_action("Create a New Team Folder")
                .add_assertion(assert_local_drive_is_open()),
        )
        .with_steps(
            open_command_palette_and_run_action("Create a New Personal Folder")
                .add_assertion(assert_local_drive_is_open()),
