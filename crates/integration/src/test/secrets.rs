...
use warp::{
    integration_testing::{
        ...
        settings::{set_secret_display_mode_to_asterisks, toggle_safe_mode_setting},
...
pub fn test_secret_is_obfuscated_on_copy() -> Builder {
    ...
    new_builder()
        ...
        .with_step(set_secret_display_mode_to_asterisks())
...
pub fn test_secret_tooltip_respects_safe_mode_setting() -> Builder {
    ...
    new_builder()
        ...
        .with_step(
            ...
            // for now. This is affected by the addition/removal of new `GridType`s!
            new_step_with_default_assertions("Click on secret to show tooltip")
                .with_click_on_last_committed_saved_position("terminal_view:first_cell_in_secret_1")
...
pub fn test_secrets_are_always_redacted_in_ai_inputs() -> Builder {
    ...
    new_builder()
        ...
        .with_step(toggle_safe_mode_setting()) // Enable safe mode with strikethrough display by default
        .with_step(execute_command_for_single_terminal_in_tab(
            0,
        ...
        .with_step(set_secret_display_mode_to_asterisks()) // Enable full hiding
        .with_step(
