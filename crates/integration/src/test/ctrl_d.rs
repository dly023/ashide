...
use warp::{
    integration_testing::{
        ...
        terminal::{
            ...
            assert_shell_ready_for_input, assert_terminal_bootstrapped,
    ...
    new_builder()
        ...
        .with_step(
            new_step_with_default_assertions("Check ctrl-d terminates the command")
                ...
                .add_assertion(assert_shell_ready_for_input(0, 0)),
        )
}
...
pub fn test_ctrl_d_handled_by_read_during_bootstrapping() -> Builder {
    new_builder()
        .set_should_run_test(|| {
            ...
            // We need to fix https://github.com/dly023/ashide/issues/1869 before
