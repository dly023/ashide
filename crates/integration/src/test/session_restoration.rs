use warp::{
    ...
    integration_testing::{
        self,
        notebook::{assert_notebook_contents, assert_notebook_metadata_revision},
...
/// Historical regression: duplicate shareable metadata IDs should not break restoration.
///
