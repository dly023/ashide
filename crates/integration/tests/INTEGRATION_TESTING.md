# Integration tests in Ashide
This is a short guide into writing integration tests in Ashide.
...
* You can copy over a ashide.sqlite file from ~/Library/Application\ Support/dev.ashide.Ashide directly
* You may want to sanitize some info that is specific to you (i.e. cwd /tmp/example-project)
