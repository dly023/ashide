//! Repository metadata utilities for Ashide.
//!
...
#[path = "current_app_model.rs"]
pub mod current_app_model;
pub mod entry;
pub mod file_tree_store;
pub mod file_tree_update;
pub mod hidden_entry_policy;
...
pub use entry::{
    ...
    BuildTreeError, DirectoryEntry, Entry, FileId, FileMetadata, SymlinkEntry, SymlinkTargetKind,
};
pub use hidden_entry_policy::{
    is_internal_metadata_path, platform_hidden, HiddenEntryKind, HiddenEntryPolicy,
};

pub use current_app_model::RepositoryMetadataEvent;
...
pub use current_app_model::{CurrentAppRepoMetadataModel, RepoContent};
