//! Node.js and npm runtime management for Ashide.
//!
...
/// 3. Extract it to the Ashide data directory
///
/// # Returns
...
/// 1. First, our custom Node.js installation in the Ashide data directory
...
pub async fn detect_system_node(path_env_var: impl AsRef<OsStr>) -> Result<()> {
    ...
    // via Ashide's inherited env rather than the captured interactive PATH.
    #[cfg(windows)]
