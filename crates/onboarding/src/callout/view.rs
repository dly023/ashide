...
pub struct OnboardingKeybindings {
    ...
    /// Display string for submitting to the active terminal agent (e.g., "⌘⏎")
    pub submit_to_terminal_agent: String,
}
...
fn get_universal_input_callout_options(
    ...
    match state {
        UniversalInputCalloutState::MeetInput => Some(CalloutOptions {
            title: localized_static("onboarding-callout-meet-input-title", "Meet the Ashide input"),
            text: format!(
                "{} {} {}",
                localized(
    ...
    match state {
        AgentModalityCalloutState::MeetTerminalInput => {
            ...
            Some(CalloutOptions {
                ...
                text: format!(
                    ...
                    keybindings.submit_to_terminal_agent,
                    localized(
                ...
                Some(CalloutOptions {
                    ...
                    text: format!(
                        ...
                        localized(
                            ...
                            "Natural language input is off by default. If enabled, you can type requests in plain English and Ashide will autodetect queries for the agent. You can always override them using"
                        ),
                        keybindings.toggle_input_mode,
                    ),
                    step: StepStatus::new(1, total_steps),
        ...
        AgentModalityCalloutState::IntroducingAgentExperience => Some(CalloutOptions {
            title: localized_static(
                ...
                "Introducing Ashide's new agent experience",
            ),
            text: localized(
