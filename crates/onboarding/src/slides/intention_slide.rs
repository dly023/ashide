...
impl IntentionSlide {
    ...
    fn render_header(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        let title = appearance
            .ui_builder()
            .paragraph(localized("onboarding-intention-title", "Welcome to Ashide"))
    ...
    fn render_agent_card(
        ...
        let checklist = {
            let items = [
                localized("onboarding-ai-feature-warp-agents", "Ashide agents"),
                localized(
    ...
    fn render_visual(&self, _appearance: &Appearance, selected_index: usize) -> Box<dyn Element> {
