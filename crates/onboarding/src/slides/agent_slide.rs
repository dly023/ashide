...
impl AgentSlide {
    ...
    fn render_disable_oz_section(
        ...
        let label = Text::new(
            localized(
                "onboarding-agent-disable-warp-agent",
                "Disable Ashide Agent",
            ),
            appearance.ui_font_family(),
            14.0,
        )
    ...
    fn render_visual(&self, _appearance: &Appearance, app: &AppContext) -> Box<dyn Element> {
