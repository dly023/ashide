...
/// User-facing names of the Ashide Drive features enabled when the terminal
/// intention is selected with Ashide Drive turned on. Shared by the login slide's
/// skip-login confirmation dialog so the list stays in sync with any future
/// surfaces that need it.
pub const LOCAL_DRIVE_FEATURES: &[&str] = &["Ashide Drive", "Session Sharing"];
