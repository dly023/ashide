...
pub(crate) struct WindowManager {
    ...
    /// We assume this won't change throughout the life of the Ashide process.
...
/// to work around it. See: https://github.com/dly023/ashide/issues/6120
fn enable_decorations_if_needed(window: &winit::window::Window, adapter_info: &AdapterInfo) {
    if adapter_has_rendering_offset_bug(adapter_info) {
        log::warn!(
            ...
            selected GPU adapter ({}). See: https://github.com/dly023/ashide/issues/6120",
            adapter_info.name,
        );
...
fn create_window(
    ...
    #[cfg(windows)]
    {
        ...
        // https://github.com/dly023/ashide/issues/8935
