...
lazy_static! {
    ...
    /// 22.1.2, in practice, Ashide windows don't render properly until 24.0.2.
...
/// alignment.
///
/// See: https://github.com/dly023/ashide/issues/6120
pub fn adapter_has_rendering_offset_bug(adapter_info: &wgpu::AdapterInfo) -> bool {
    ...
    // https://github.com/dly023/ashide/issues/6120.
    let affected_models = [
