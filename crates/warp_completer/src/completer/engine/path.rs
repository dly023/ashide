...
impl EngineDirEntry {
    ...
    pub fn platform_hidden(&self) -> bool {
...
impl TryFrom<DirEntry> for EngineDirEntry {
    ...
    fn try_from(value: DirEntry) -> Result<Self, Self::Error> {
        ...
        Ok(Self {
            ...
            file_type,
            platform_hidden: repo_metadata::platform_hidden(&metadata),
            ignored: false,
        })
    }
}
...
async fn list_directory_contents(
    ...
    dir_entries
        ...
        .filter_map(move |entry| {
            ...
            ((!entry.is_hidden() && !entry.platform_hidden() && !entry.ignored())
                || split_path.file_name.starts_with('.'))
            .then(|| {
