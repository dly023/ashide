...
fn test_backtick_escape_char() {
    let source = r#"& "$HOME\Downloads\Ashide` Setup.exe" /SP- /SILENT `t`"#;
    ...
    assert_eq!(
        ...
        [
            ...
            (Token::Literal(r"HOME\Downloads\Ashide"), Span::new(4, 25)),
            (Token::EscapeChar("`"), Span::new(25, 26)),
            (Token::Whitespace(" "), Span::new(26, 27)),
            (Token::Literal("Setup.exe"), Span::new(27, 36)),
            (Token::DoubleQuote, Span::new(36, 37)),
            (Token::Whitespace(" "), Span::new(37, 38)),
            (Token::Literal("/SP-"), Span::new(38, 42)),
            (Token::Whitespace(" "), Span::new(42, 43)),
            (Token::Literal("/SILENT"), Span::new(43, 50)),
            (Token::Whitespace(" "), Span::new(50, 51)),
            (Token::EscapeChar("`"), Span::new(51, 52)),
            (Token::Literal("t"), Span::new(52, 53)),
