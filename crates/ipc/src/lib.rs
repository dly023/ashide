...
//!
//! This is intended to initially be used to support communication between the Ashide app and
...
//! the WebWorkers `MessagePort` API in the browser for Ashide on Web.
//!
