...
//!
//! ## How does a11y work in Ashide?
//! Because Ashide uses its own rust UI framework (warpui), we don’t benefit from the built-in
...
pub struct AccessibilityContent {
    ...
    /// Frame support is a work-in-progress in Ashide and right now this field is omitted and not set.
