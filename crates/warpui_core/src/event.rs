...
pub enum Event {
    ...
    MouseMoved {
        ...
        cmd: bool,
        shift: bool,
        /// Whether this mouse event was initiated by the user or by Ashide synthetically.
        /// We create such synthetic mouse events for certain behaviors behaviors within
        /// Ashide, such as triggering the correct tab to be "hovered" when the user closes
        ...
        /// the old tab (closed) to the new tab (shifted). Certain elements within Ashide,
    ...
    /// Gets fired when user drags a file or folder into Ashide. Note that there could exist
