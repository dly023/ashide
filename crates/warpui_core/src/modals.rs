...
pub struct AlertDialog {
    ...
    /// Whether the modal should expose a "don't show again" suppression checkbox.
    pub show_disable_checkbox: bool,
}
...
impl AlertDialogWithCallbacks<AppModalCallback> {
    ...
    pub fn with_disable_checkbox(mut self) -> Self {
        self.show_disable_checkbox = true;
        self
    }
}
