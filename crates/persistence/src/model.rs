...
pub struct Team {
    ...
    pub workspace_policy_json: Option<String>,
}
...
/// The [`pane_leaves::kind`] value for runtime Environment placeholder panes.
pub const ENVIRONMENT_RUNTIME_PLACEHOLDER_PANE_KIND: &str = "environment_runtime_placeholder";
...
pub struct Block {
    ...
    /// JSON-serialized representation of the Ashide prompt snapshot (Context Chips). Note that this
...
pub struct NewCommand {
    ...
    pub git_branch: Option<String>,
    pub object_store_workflow_id: Option<String>,
...
#[derive(Insertable)]
#[diesel(table_name = stored_objects_refreshes)]
...
pub struct AgentConversationData {
    ...
    /// SessionBridge native import provenance for sessions written from bundles.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub session_bridge_import: Option<SessionBridgeImportMetadata>,
}

#[derive(Debug, Serialize, Deserialize, Clone, PartialEq, Eq)]
#[serde(rename_all = "camelCase")]
pub struct SessionBridgeImportMetadata {
    pub source_session_id: String,
    pub imported_at: String,
    pub source_reference: String,
    pub source_sha256: String,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub derivation_metadata: Option<serde_json::Value>,
}
...
pub struct ConversationUsageMetadata {
    ...
    pub usage_units: f32,
    #[serde(default)]
    pub usage_units_for_last_block: Option<f32>,
    #[serde(default)]
