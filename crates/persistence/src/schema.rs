...
diesel::table! {
    commands (id) {
        ...
        git_branch -> Nullable<Text>,
        object_store_workflow_id -> Nullable<Text>,
...
diesel::table! {
    pane_container_identities (pane_node_id) {
        pane_node_id -> Integer,
        uuid -> Binary,
        session_binding_json -> Nullable<Text>,
    }
}
...
diesel::table! {
    teams (id) {
        ...
        name -> Text,
        server_uid -> Text,
        workspace_policy_json -> Nullable<Text>,
    }
}
...
diesel::table! {
    windows (id) {
        ...
        local_drive_index_width -> Nullable<Float>,
