...
impl Shell {
    ...
    ///
    /// These sequences are bound to Ashide shell functions during session bootstrap that print the
...
impl ShellType {
    ...
    /// If true, Ashide will bootstrap the shell if it's the login shell on the remote host.
                        ...
                        output_string
                            ...
                            .flat_map(|line| {
                                ...
                                for ext in PATHEXT {
                                    ...
                                    // Ashide about this command as-is and also sans-suffix, e.g.
                                    // "git" and "git.exe".
...
impl ShellLaunchData {
    ...
    fn to_native_path_encoding(&self, path_str: &str) -> Option<PathBuf> {
        match self {
            ...
            // The container is Unix; Ashide runs on the host, so paths are
