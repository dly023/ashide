...
impl EnvironmentFileRuntime {
    ...
    fn write_file(
        ...
        (self.write_file)(host_id, session_id, path, content, ctx)
    }
    ...
    fn delete_file(
        ...
        (self.delete_file)(host_id, session_id, path, ctx)
    }
}
...
enum FileBackend {
    ...
    Remote {
        ...
        host_id: HostId,
        /// Stable transport binding selected by the owning UI/session.
        session_id: SessionId,
...
impl FileModel {
    ...
    pub fn register_remote_file(
        ...
        self.file_state
            .insert_remote(file_id, host_id, session_id, path);
        file_id
    }
    ...
    pub fn save(
        ...
        match backend {
            ...
            FileBackend::Remote {
                ...
                let future = runtime.write_file(host_id, *session_id, path, content, ctx)?;
                ctx.spawn(
                    future,
    ...
    pub fn delete(
        ...
        match backend {
            ...
            FileBackend::Remote {
                ...
                let runtime = self.environment_file_runtime()?;
                let path = path.as_str().to_string();
                let future = runtime.delete_file(host_id, *session_id, path, ctx)?;
                ctx.spawn(
                    future,
                    move |me, result: Result<(), String>, ctx| match result {
                        Ok(()) => {
