...
pub struct AIRequestedCodeDiff {
    ...
    /// Types of failures to create the diff that we want to capture for diagnostics.
...
/// the upstream suggest_diff tool schema
...
///
/// Also returns the number of fuzzy matches that failed for diagnostics.
///
/// Method
