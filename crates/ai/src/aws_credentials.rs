    ...
    pub fn user_facing_components(&self) -> (String, String, Icon) {
        match self {
            ...
            Self::Disabled => (
                ...
                "Ashide will not load your AWS CLI credentials until AWS Bedrock is enabled by you or your workspace admin"
                    .to_string(),
                Icon::Key,
            ),
            Self::Refreshing => (
                "Refreshing credentials...".to_string(),
                "Loading your AWS CLI credentials into Ashide".to_string(),
                Icon::RefreshCw04,
            ),
            Self::Loaded {
                credentials,
