...
fn default_port_omitted() {
    ...
    assert!(
        line == "ssh -o ServerAliveInterval=30 -o ServerAliveCountMax=6 -o TCPKeepAlive=yes alice@1.2.3.4"
            || line
                == "ssh -o ServerAliveInterval=30 -o ServerAliveCountMax=6 -o TCPKeepAlive=yes 'alice@1.2.3.4'",
        "unexpected: {line}"
    );
}
