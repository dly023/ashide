...
impl Adapter for OpenAIRespAdapter {
	...
	fn to_web_request_data(
		...
		// reasoning effort level. Non-reasoning models reject any request that
		// includes a `reasoning` key and return 400/502. The app may set
		// `capture_reasoning_content` broadly, so it cannot be used as this gate.
