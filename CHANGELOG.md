...
- **开源预览**:首个 Ashide local-first 开源预览版本，完成 release-readiness commit、固定 gate、release note 与 macOS 首发包准备。
- **SessionBridge**:会话 Fork / Edit and Fork / portable bundle export 进入固定 release gate；Ashide/Codex/Claude 通过 adapter registry 做 native history 转换，不做 LLM 总结。
- **远程/本地隔离**:remote authority 贯穿远程会话 read/write/fork/resume，防止远程 session 写回本机 provider history。
- **Local-first hard cut**:清理云端遥测、pricing/billing/paywall、旧 cloud product surface 和过时文档/品牌残留。
- **构建与发布**:dev/daily app variant 隔离；远程 helper 与 macOS bundle 使用 scoped freshness，避免无谓编译。
- **UI/品牌**:默认 Solarized Dark；app icon、provider picker、Session Navigator、窗口 traffic lights、工具面板聚焦等完成真实 GUI 验证。
...
- **i18n**:中文国际化补齐(设置面板等)
- **网站**:GitHub 地址统一为 `dly023/ashide`;移动端横向溢出修复
...
[Unreleased]: https://github.com/dly023/ashide/compare/v0.1.0-oss.20260623...HEAD
[v0.1.0-oss.20260623]: https://github.com/dly023/ashide/releases/tag/v0.1.0-oss.20260623
[v2026.05.06.preview]: https://github.com/dly023/ashide/compare/v2026.05.04.preview...v2026.05.06.preview
[v2026.05.04.preview]: https://github.com/dly023/ashide/compare/v2026.05.03.preview.4...v2026.05.04.preview
[v2026.05.03.preview(.2/.3/.4)]: https://github.com/dly023/ashide/compare/v2026.05.02.preview...v2026.05.03.preview.4
[v2026.05.02.preview]: https://github.com/dly023/ashide/compare/v2026.05.01.preview...v2026.05.02.preview
[v2026.05.01.preview]: https://github.com/dly023/ashide/compare/v2026.04.30.oss...v2026.05.01.preview
[v2026.04.30.oss]: https://github.com/dly023/ashide/compare/v2026.04.30.preview...v2026.04.30.oss
[v2026.04.30.preview]: https://github.com/dly023/ashide/releases/tag/v2026.04.30.preview
