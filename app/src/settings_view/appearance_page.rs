...
use crate::settings::{
    ...
    PaneSettings, ThemeSettings, UiFontName, DEFAULT_MONOSPACE_FONT_NAME, UI_FONT_SIZE_MAX,
    UI_FONT_SIZE_MIN,
};
...
pub fn init_actions_from_parent_view<T: Action + Clone>(
    ...
    // Add command palette entry for toggling between Ashide and Classic input modes
    app.register_fixed_bindings(vec![FixedBinding::empty(
        "Toggle Input Mode (Ashide/Classic)".to_string(),
        builder(SettingsAction::AppearancePageToggle(
...
pub struct AppearanceSettingsPageView {
    ...
    /// selected universal input configuration.
        ...
        let alt_screen_padding_editor = {
            ...
            ctx.add_typed_action_view(|ctx| {
                    ...
                    *TerminalSettings::as_ref(ctx).alt_screen_padding
                {
                    ...
                    // Do a system edit so this derived value does not appear as a user edit.
...
impl SettingsWidget for ToolsPanelStateScopeWidget {
    ...
    fn search_terms(&self) -> &str {
        "left tools panel open closed across tabs file tree project explorer global search Ashide Drive"
    }
...
impl SettingsWidget for VerticalTabsWidget {
    ...
    fn search_terms(&self) -> &str {
        "session navigator vertical tabs sidebar layout environments agents panes"
    }
...
impl SettingsWidget for ShowVerticalTabPanelInRestoredWindowsWidget {
    ...
    fn search_terms(&self) -> &str {
        "session navigator restore window vertical tabs panel environment snapshot"
    }
