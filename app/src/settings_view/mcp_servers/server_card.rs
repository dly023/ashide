        ...
        match self.item_id {
            ...
            ServerCardItemId::TemplatableMCPInstallation(installation_uuid) => {
                ...
                if let Some(installation) = installation {
                    ...
                    let template_object_store_id_text = match server_object {
                        Some(server_object) => {
                            format!("Template sync id: {}", server_object.object_store_id())
                        }
                    ...
                    lines.push(template_object_store_id_text);
                }
            }
