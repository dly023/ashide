...
use crate::{
    appearance::Appearance, editor::EditorView, object_store::ids::ObjectStoreId,
...
pub struct ObjectNamingDialog {
    ...
    pub open_for_folder_id: Option<ObjectStoreId>,
}
...
impl ObjectNamingDialog {
    ...
    pub fn is_open_for_folder(&self, folder_id: ObjectStoreId) -> bool {
