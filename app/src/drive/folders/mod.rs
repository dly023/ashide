use super::items::folder::LocalDriveFolder;
use super::items::LocalDriveItem;
use super::ObjectTypeAndId;
use crate::{
    appearance::Appearance,
    object_store::ids::ObjectStoreId,
    object_store::{GenericStoredObject, ObjectType, SerializedModel, Space, StoredObjectModel},
    persistence::ModelEvent,
};

pub use crate::object_store::ids::FolderId;
...
impl StoredObjectModel for FolderObjectModel {
    ...
    fn to_local_drive_item(
        ...
        Some(Box::new(LocalDriveFolder::new(
