...
/// Creates a CurrentAppCodeEditorView with the given content
fn create_editor_with_content(
    app: &mut App,
    content: &str,
...
/// Creates a CurrentAppCodeEditorView with base and current content for diff testing
#[allow(dead_code)]
...
fn create_loaded_state_with_editors(
    app: &mut App,
    window_id: warpui::WindowId,
    file_editors: Vec<(PathBuf, ViewHandle<CurrentAppCodeEditorView>)>,
) -> LoadedState {
