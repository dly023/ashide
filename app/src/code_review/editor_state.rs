...
use crate::code::current_app_code_editor::CurrentAppCodeEditorView;

pub struct CodeReviewEditorState {
    pub editor: ViewHandle<CurrentAppCodeEditorView>,
    ...
    /// This is set to true when CurrentAppCodeEditorEvent::DelayedRenderingFlushed or FailedToLoad fires.
    is_loaded: bool,
}

impl CodeReviewEditorState {
    #[cfg(not(target_family = "wasm"))]
    pub fn new(editor: ViewHandle<CurrentAppCodeEditorView>) -> Self {
        Self {
            editor,
    ...
    pub fn new_loaded(editor: ViewHandle<CurrentAppCodeEditorView>) -> Self {
        Self {
            editor,
            unsaved_changes_mouse_state: MouseStateHandle::default(),
            editor_mouse_state: MouseStateHandle::default(),
    ...
    pub fn editor(&self) -> &ViewHandle<CurrentAppCodeEditorView> {
        &self.editor
    }
