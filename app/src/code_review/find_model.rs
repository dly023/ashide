...
impl CodeReviewFindModel {
    ...
    pub fn update_query(
        &mut self,
        query: Option<String>,
        editor_handles: impl Iterator<Item = ViewHandle<CurrentAppCodeEditorView>>,
    ...
    pub fn focus_next_find_match(
        ...
        mut editor_handles: impl Iterator<Item = ViewHandle<CurrentAppCodeEditorView>>,
        ctx: &mut ModelContext<Self>,
    ) {
    ...
    pub fn run_search(
        &mut self,
        _editor_handles: impl Iterator<Item = ViewHandle<CurrentAppCodeEditorView>>,
        _ctx: &mut ModelContext<Self>,
    ) {
