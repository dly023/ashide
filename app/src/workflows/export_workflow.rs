...
impl ExportArgument {
            ...
            ExportArgumentType::Enum {
                ...
                match workflow_enum {
                    Ok(enum_data) => {
                        ...
                        ArgumentType::Enum {
                            enum_id: ObjectStoreId::ClientId(client_id),
                        }
                    }
    ...
    fn try_into_workflow_enum(
        ...
        // Always create non-reusable enums on import
        let is_reusable = false;
    ...
    impl<'de> Visitor<'de> for WorkflowVisitor {
            ...
            V: MapAccess<'de>,
        {
            ...
            let (
                ...
                (EnvironmentVariables, "environment_variables", environment_variables, Option<ObjectStoreId>, true),
            );
