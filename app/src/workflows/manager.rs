...
use crate::{
    ...
    object_store::{model::persistence::ObjectStoreModel, GenericStoredObject, Owner},
...
impl WorkflowManager {
    pub fn new(_ctx: &mut ModelContext<Self>) -> Self {
        // Local-only manager: panes are keyed by the object id used at creation/load time.
        // There is no remote id conversion event to subscribe to.
        WorkflowManager {
        ...
        match source {
            ...
            WorkflowOpenSource::New {
                ...
                view.open_new_workflow(
                    ...
                    *initial_folder_id,
                    *is_for_agent_mode,
                    ObjectStoreId::ClientId(ClientId::default()),
                    ctx,
                )
            }),
