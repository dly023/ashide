use crate::{
    object_store::ids::{ClientId, HashableId, ObjectStoreId, StableObjectId},
    object_store::model::generic_string_model::GenericStringObjectId,
...
fn test_workflow_serialization_with_enum_params() {
    let workflow = Workflow::Command {
        ...
        arguments: vec![
            ...
            Argument {
                name: "stable id enum".to_string(),
                arg_type: ArgumentType::Enum {
                    enum_id: ObjectStoreId::from(GenericStringObjectId::from(
                        StableObjectId::from(123),
                    )),
                },
            ...
            Argument {
                ...
                arg_type: ArgumentType::Enum {
                    enum_id: ObjectStoreId::ClientId(
    ...
    let correct_serialized = r#"{"name":"name","command":"command","tags":[],"description":null,"arguments":[{"name":"text","arg_type":"Text","description":null,"default_value":"default"},{"name":"stable id enum","arg_type":"Enum","enum_id":"test_uid00000000000123","description":"description","default_value":null},{"name":"client id enum","arg_type":"Enum","enum_id":"Client-06d26381-ac61-4a4a-8a23-a3431f1d340c","description":"description","default_value":null}],"source_url":null,"author":null,"author_url":null,"shells":[],"environment_variables":null}"#;
