...
use crate::{
    drive::items::{env_var_collection::LocalDriveEnvVarCollection, LocalDriveItem},
...
impl StringModel for EnvVarCollection {
    ...
    fn to_local_drive_item(
        ...
        Some(Box::new(LocalDriveEnvVarCollection::new(
...
pub fn serialize_variables_for_shell<'s, I: IntoIterator<Item = (&'s str, &'s EnvVarValue)>>(
    ...
    match shell_type {
        // Fish cannot round-trip embedded newlines through this env syntax.
        ShellType::Fish => {
