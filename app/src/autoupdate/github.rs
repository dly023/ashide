// Ashide OSS autoupdate 走 GitHub Releases API,不再请求旧上游 channel_versions / GCS。
// 本模块只负责"取最新 release 元数据" + "按文件名挑资产";
...
const REPO_OWNER: &str = "dly023";
const REPO_NAME: &str = "ashide";

// GitHub 强制要求 User-Agent;同时显式声明 API 版本避免未来 default 漂移。
const USER_AGENT: &str = "Ashide-Autoupdate";
