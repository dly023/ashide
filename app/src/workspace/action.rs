...
use crate::environment_authority::session_authority_or_terminal_bootstrap;
...
pub struct WorkspaceSessionActionTarget {
    ...
    pub environment_authority_key: String,
}
...
impl WorkspaceSessionActionTarget {
    pub fn new(session_id: String, environment_authority_key: Option<String>) -> Self {
        Self {
            session_id,
            environment_authority_key: session_authority_or_terminal_bootstrap(
...
pub enum WorkspaceAction {
    ...
    /// User explicitly reset the row's object-owned name override.
    ...
    /// 显式刷新 Environment Strip SSH target catalog。
    ...
    ShowSessionBridgeEditDialog {
        source: SessionBridgeActionSource,
        initial_fork_target: SessionBridgeForkTarget,
    },
