...
//! It's intentionally small and current-app-only.
...
const WARP_HOME_TITLE: &str = "Welcome to Ashide";
const WARP_HOME_CONTENT: &str = r#"
Welcome to Ashide.

Use this workspace to:
* Create, view, and edit Ashide Drive objects
* Manage app settings
* Work with agent sessions, notebooks, and workflows"#;
