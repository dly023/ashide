    ...
    fn render(&self, app: &AppContext) -> Box<dyn Element> {
        match self.enablement {
            ...
            | CodingPanelEnablementState::RuntimeSession { .. } => {
                return self.render_environment_runtime_state(app);
            }
...
impl GlobalSearchView {
    ...
    fn render_environment_runtime_state(&self, app: &AppContext) -> Box<dyn Element> {
        self.render_zero_state(
            Icon::AlertTriangle,
            crate::t!("global-search-unavailable-title"),
            crate::t!("global-search-environment-description"),
            app,
        )
    }
