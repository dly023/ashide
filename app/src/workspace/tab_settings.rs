...
define_settings_group!(TabSettings, settings: [
    ...
    use_vertical_tabs: UseVerticalTabs {
        type: bool,
        // Ashide treats the vertical panel as the default Session Navigator.
        // The horizontal bar is being repurposed into an Environment Strip,
        // so sessions should prefer the vertical surface by default.
        default: true,
        supported_platforms: SupportedPlatforms::ALL,
        private: false,
        toml_path: "appearance.vertical_tabs.enabled",
        description: "Whether to show the Session Navigator for environment sessions and panes.",
    },
