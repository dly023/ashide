...
diesel migration run --database-url="/Users/$USER/Library/Application Support/dev.ashide.Ashide/ashide.sqlite"
```
...
```
diesel print-schema --database-url="/Users/$USER/Library/Application Support/dev.ashide.Ashide/ashide.sqlite"
```
...
```
diesel migration revert --database-url="/Users/$USER/Library/Application Support/dev.ashide.Ashide/ashide.sqlite"
diesel migration redo --database-url="/Users/$USER/Library/Application Support/dev.ashide.Ashide/ashide.sqlite"
```
