...
use crate::object_store::model::actions::ObjectAction;
use crate::object_store::model::generic_string_model::StoredStringObject;

use crate::drive::folders::FolderObject;
use crate::notebooks::NotebookObject;
use crate::object_store::ids::ObjectStoreId;
use crate::object_store::{ObjectIdType, StoredObject, StoredObjectMetadata};
...
pub struct PersistedData {
    ...
    /// Shareable objects.
    pub stored_objects: Vec<Box<dyn StoredObject>>,
