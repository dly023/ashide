...
use crate::{
    object_store::ids::{HashableId, ObjectStoreId, StableObjectId, ToStableObjectId},
    object_store::{
...
{
    let id = ObjectStoreId::StableId(StableObjectId::try_from(id).expect("ID is invalid"));
