...
use crate::{
    integration_testing::{object_store::assert_metadata_revision, view_getters::workflow_view},
    object_store::ids::ObjectStoreId,
    workflows::{workflow_view::WorkflowView, WorkflowId, WorkflowObjectModel},
};
...
pub fn open_workflow_count(app: &App, id: ObjectStoreId) -> usize {
    app.window_ids()
        .into_iter()
