...
#[cfg(feature = "local_fs")]
use super::proto::{
    create_directory_response, list_directory_response, mutate_cli_agent_session_response,
    ...
    scan_cli_agent_sessions_response,
    write_file_chunk_response, BufferEdit, BufferUpdatedPush, CliAgentSessionMutation,
    CliAgentSessionRecord, CloseBuffer, CreateDirectory, CreateDirectoryResponse,
    CreateDirectorySuccess, DirEntry, FileSystemEntryKind, ListDirectory, ListDirectoryResponse,
    ListDirectorySuccess, MutateCliAgentSession, MutateCliAgentSessionResponse,
    MutateCliAgentSessionSuccess, OpenBuffer, OpenBufferResponse, ReadCliAgentSession,
    ReadCliAgentSessionResponse, ReadCliAgentSessionSuccess, ReadFileChunk, ReadFileChunkResponse,
    ReadFileChunkSuccess, ResolveConflict, ResolveConflictResponse, ResolveConflictSuccess,
    RenameFile, RenameFileResponse, RenameFileSuccess, ResolvePath, ResolvePathResponse,
    ResolvePathSuccess, SaveBuffer, SaveBufferResponse,
    SaveBufferSuccess, ScanCliAgentSessions, ScanCliAgentSessionsResponse,
...
impl ServerModel {
    ...
    fn handle_mutate_cli_agent_session(&self, msg: MutateCliAgentSession) -> HandlerOutcome {
        ...
        let result = match super::cli_agent_sessions::mutate_session(&msg.source, mutation) {
            Ok(()) => mutate_cli_agent_session_response::Result::Success(
                MutateCliAgentSessionSuccess {},
            ),
            Err(message) => {
