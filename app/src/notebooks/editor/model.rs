...
use crate::{
    ...
    notebooks::interaction::BlockInfo,
    object_store::model::persistence::{ObjectStoreEvent, ObjectStoreModel},
};
use crate::{
...
use super::{
    super::interaction::SelectionMode as NotebookSelectionMode, embedding_model::NotebookEmbed,
