...
use crate::{
    ...
    notebooks::{
        ...
        interaction::{ActionEntrypoint, BlockInfo, EmbeddedObjectInfo, SelectionMode},
    ...
    util::{
        ...
        tooltips::{
            render_tooltip, should_show_open_in_ashide_link, TooltipLink, TooltipRedaction,
        },
    },
...
pub enum EditorViewAction {
    ...
    MiddleClickPaste,
    /// Open a file. If open_in_warp is true, open in Ashide's code editor; otherwise use external editor.
    OpenFile {
        path: PathBuf,
...
impl RichTextEditorView {
    ...
    fn handle_model_event(
        ...
        match event {
            RichTextEditorModelEvent::ContentChanged(origin) => {
                ...
                // - Object-store updates, which must not be echoed back
                if origin.from_user() {
    ...
    fn render_file_path_tooltip(
        ...
        .to_string();
        let show_open_in_ashide = should_show_open_in_ashide_link(&path, ctx);
...
impl RichTextAction<RichTextEditorView> for EditorViewAction {
    ...
    fn left_mouse_down(
        ...
        // The first mouse down to bring focus to a Ashide window will not have a corresponding mouse up.
