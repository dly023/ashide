...
/// * Interactive breadcrumbs for its location within Ashide Drive
...
impl DetailsBar {
        ...
        header_row.add_child(
            Shrinkable::new(
                ...
                render_breadcrumbs(
                    ...
                    appearance,
                    |ctx, _, breadcrumb| {
                        ctx.dispatch_typed_action(NotebookAction::ViewInLocalDrive(
    ...
    fn render_mode_toggle(
        ...
        // Ashide UX: 给 "铅笔" 切换按钮加 tooltip,避免用户(特别是首次使用)
