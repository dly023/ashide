...
/// Returns a JS object representing the Ashide Plugin API exposed to external JavaScript plugins.
///
...
/// Returns a JS object representing the Completions namespace for the Ashide Plugin API.
///
/// API methods:
///
