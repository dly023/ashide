...
//! Ashide (including Agent Mode).
//!
//! The side panel Ashide AI implementation lives in `super::ai_assistant`.
pub(crate) mod agent;
...
#[cfg(not(target_family = "wasm"))]
pub mod agent_sdk;
// Ashide Wave 7-3:`ambient_agent_settings` 随 ambient-agent UI 子系统物理删。
// Ashide Wave 7-2:Cloud environments 的 CLI / 表单 / 环境准备链路已删；
// 本地对象数据类型仍暂存于此，供 ObjectStoreModel 反序列化与现有视图过滤使用。
pub mod execution_profiles;
pub mod facts;
// Ashide Wave 6-8:`generate_block_title` 随 `BlockClient::generate_shared_block_title`
