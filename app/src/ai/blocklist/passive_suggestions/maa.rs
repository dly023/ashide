...
impl PassiveSuggestionsModel {
    ...
    fn handle_finished_stream(
        ...
        // Ashide:暂时关闭 AgentResponseCompleted 触发的 passive suggestions 云端请求,
...
async fn extract_suggestion_from_stream(
    ...
    // Drain the stream, collecting all client actions.
...
async fn read_files(
    ...
    let file_future = read_current_app_file_context(
        &file_locations,
