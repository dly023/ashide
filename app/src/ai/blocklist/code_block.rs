...
impl CodeBlockStyle {
    pub fn from_appearance(appearance: &Appearance) -> Self {
        ...
        Self {
            ...
            text: blended_colors::text_main(theme, body_background),
            sub_text: blended_colors::text_sub(theme, body_background),
            body_background,
        }
    }
...
fn render_linked_code_block_internal(
    ...
    content.add_child(
        Container::new(header_row.finish())
            .with_background(style.header_background)
    ...
    content.add_child(
        Container::new(code_element)
            .with_background(style.body_background)
            .with_vertical_padding(INLINE_ACTION_HEADER_VERTICAL_PADDING)
            .with_horizontal_padding(INLINE_ACTION_HORIZONTAL_PADDING)
...
fn render_code_block_internal(
    ...
    Container::new(content.finish())
        .with_border(Border::all(1.).with_border_fill(style.border))
