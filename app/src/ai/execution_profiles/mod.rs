...
use crate::object_store::UniquePer;
...
pub enum AskUserQuestionPermission {
    ...
    Never,
    /// 在 Ashide 中等同于 `AlwaysAsk`:auto-approve 模式不再静默跳过用户问题,
...
pub struct AIExecutionProfile {
    ...
    /// Whether plans created by the agent should be saved into the local Drive
    pub auto_save_plans_to_local_drive: bool,
...
impl Default for AIExecutionProfile {
    fn default() -> Self {
        Self {
            ...
            auto_save_plans_to_local_drive: false,
...
impl AIExecutionProfile {
    ...
    pub fn create_default_cli_profile(
        ...
        Self {
            ...
            next_command_model: None,
            context_window_limit: None,
            auto_save_plans_to_local_drive: FeatureFlag::SaveAmbientPlansToLocalDrive.is_enabled(),
            web_search_enabled: true,
        }
    }
}
