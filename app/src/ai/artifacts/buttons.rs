    ...
    for artifact in artifacts {
        match artifact {
            ...
            | Artifact::File {
                ...
                // File/screenshot artifacts are retained for task metadata, but have no
                // direct button action in this view.
            }
        }
    }
