...
static DEFAULT_TIPS: LazyLock<Vec<AgentTip>> = LazyLock::new(|| {
    vec![
        ...
        AgentTip {
            description: crate::t!("agent-tip-local-drive"),
            link: Some("".to_string()),
            binding_name: None,
            action: Some(WorkspaceAction::LocalDrive),
            kind: AgentTipKind::LocalDrive,
        },
        AgentTip {
...
impl WorkspaceAction {
    pub fn display_text(&self) -> Option<String> {
        match self {
            ...
            WorkspaceAction::LocalDrive => Some(crate::t!("agent-tip-action-local-drive")),
