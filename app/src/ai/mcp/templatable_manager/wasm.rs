...
use crate::object_store::update_manager::InitiatedBy;
use crate::object_store::Space;
...
impl TemplatableMCPServerManager {
    ...
    /// Updates a TemplatableMCPServer in Ashide Drive.
    ///
    /// This is a no-op in WASM, as MCP servers are not supported in WASM.
    ...
    /// Gets all TemplatableMCPServers currently in Ashide Drive.
    ///
    /// This is a no-op in WASM, as MCP servers are not supported in WASM.
    ...
    /// Creates a new TemplatableMCPServer in Ashide Drive.
    ///
    /// This is a no-op in WASM, as MCP servers are not supported in WASM.
    ...
    /// Deletes a TemplatableMCPServer from Ashide Drive.
    ///
    /// This is a no-op in WASM, as MCP servers are not supported in WASM.
    ...
    pub fn get_first_team_space_id(_app: &AppContext) -> Option<StableObjectId> {
