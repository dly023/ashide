...
pub struct AgentConfigSnapshot {
    ...
    /// Profile ID for current-app agent runs. This configures the terminal session
    ...
    /// If None, the task runner chooses its default harness.
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
impl AgentSource {
    ...
    pub fn display_name(&self) -> &str {
        match self {
            ...
            AgentSource::Interactive => "Ashide (interactive agent)",
...
pub struct AmbientAgentTask {
    ...
    /// Cursor for persisted task event streams.
    #[serde(default)]
