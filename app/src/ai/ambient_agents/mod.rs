...
pub const SERVER_OVERLOADED_TASK_FAILURE_MESSAGE: &str =
    "Ashide is temporarily overloaded. Please try again shortly.";

/// JSON payload for starting an agent run through local UI/CLI plumbing.
...
pub struct SpawnAgentRequest {
    ...
    /// Use an agent skill as the base prompt.
...
impl AmbientAgentTaskId {
    /// Generate a local task id without calling a remote pre-create endpoint.
