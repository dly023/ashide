//! Ashide Drive 本地文档系统的 read / edit / create 三件套。
//!
...
pub static READ_DOCUMENTS: OpenAiTool = OpenAiTool {
    name: "read_documents",
    description: "读取 Ashide Drive 本地文档(由 document_id 引用,不是文件系统中的文件)。\
...
pub static EDIT_DOCUMENTS: OpenAiTool = OpenAiTool {
    name: "edit_documents",
    description: "对 Ashide Drive 中已存在的 document 做字符串搜索-替换。\
...
pub static CREATE_DOCUMENTS: OpenAiTool = OpenAiTool {
    ...
    description: "在 Ashide Drive 中创建一个或多个新 document(各带 title + 完整内容)。\
