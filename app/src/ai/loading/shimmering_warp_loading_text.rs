//! Shimmering Ashide loading text - renders Ashide logo with shimmering text for loading states.
...
/// Ashide icon glyph character
const WARP_GLYPH: &str = "\u{E500}";

/// Creates a shimmering text element with the Ashide glyph.
