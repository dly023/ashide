...
//! depends on the platform. The Ashide app must use this information to avoid rendering UI elements
//! underneath them.
...
/// Data the Ashide app needs to avoid rendering anything below the traffic lights.
#[derive(Clone, Debug)]
