...
/// user to have logged in, or for the initial load of Ashide Drive objects to have finished). When
...
///
/// We use this in Ashide Drive to wait for the initial load of changed objects to finish. Regular UI
