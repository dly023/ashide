...
pub enum TipAction {
    ...
    SaveNewLaunchConfig,
    AiAssistant,
    // This toggles Ashide Drive rather than opening it. This enum can't directly be
...
impl TipAction {
    pub fn editable_binding_name(&self) -> &'static str {
        match self {
            ...
            TipAction::AiAssistant => "workspace:toggle_ai_assistant",
            TipAction::LocalDrive => "workspace:toggle_left_panel",
