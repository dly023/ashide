...
use super::{current_app_code_editor::CurrentAppCodeEditorView, editor_management::CodeSource};
...
impl CodeView {
    ...
    pub fn open_or_focus_existing(
        ...
        if let Some(path) = path {
            self.open_current_app_file(None, path, line_col, ctx);
        }
    }
    ...
    pub fn current_app_path(&self, _ctx: &AppContext) -> Option<PathBuf> {
        None
    }
