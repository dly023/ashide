...
impl FileTreeView {
    ...
    fn set_is_active_current_app_file_system(
        ...
        if is_active {
            ...
            if !existing_environment_repo_ids.is_empty() {
                self.insert_or_update_environment_roots(&existing_environment_repo_ids, false, ctx);
            }
        } else {
        ...
        for environment_repo_id in environment_repo_ids {
            ...
            self.root_directories
                ...
                .and_modify(|root_dir| {
                    ...
                    root_dir.environment_host_id = Some(host_id.clone());
                })
    ...
    pub fn set_environment_root_directories(
        ...
        if !repos.is_empty() {
            ...
            // when necessary.
            self.insert_or_update_environment_roots(repos, false, ctx);
