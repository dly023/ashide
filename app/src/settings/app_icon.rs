...
///
/// IMPORTANT NOTE: If you add a new icon, you will need to update the logic in AshideDockTilePlugin.m
...
pub enum AppIcon {
    ...
    Comets,
    /// Cow icon, for Code on Ashide launch.
