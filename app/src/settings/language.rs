...
//! 设置页 dropdown 应附"重启 Ashide 后完全生效"提示。
...
#[schemars(
    description = "The language used in Ashide's user interface.",
...
define_settings_group!(LanguageSettings, settings: [
    language: LanguageState {
        ...
        description: "The language used in Ashide's user interface. Falls back to English when the chosen language is not fully translated.",
    },
]);
