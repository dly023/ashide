...
/// This enum is used to enforce options in the dropdown for selecting a separator with universal input.
/// These separators are added at the end of the same-line prompt.
#[derive(
    Clone,
    Copy,
    Debug,
