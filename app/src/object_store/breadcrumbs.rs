...
use crate::{
    drive::{folders::FolderObject, items::LocalDriveItemId, ObjectTypeAndId},
...
impl ContainingObjectKind {
    pub fn into_item_id(self) -> LocalDriveItemId {
        match self {
            ContainingObjectKind::Space(space) => LocalDriveItemId::Space(space),
            ContainingObjectKind::Object(object) => LocalDriveItemId::Object(object),
        }
    }
}
