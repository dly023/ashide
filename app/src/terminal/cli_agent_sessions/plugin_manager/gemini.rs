...
impl CliAgentPluginManager for GeminiPluginManager {
    ...
    fn install_success_message(&self) -> &'static str {
        "Ashide plugin installed. Please restart Gemini CLI to activate."
    }

    fn update_success_message(&self) -> &'static str {
        "Ashide plugin updated. Please restart Gemini CLI to activate."
    }
...
/// Reads the installed version string for the Ashide extension, if present.
