...
/// Returns `true` if Ashide should use an RC-file based bootstrap (e.g. dump the bootstrap script to
...
pub fn should_use_rc_file_bootstrap_method(
    ...
    shell_type == ShellType::Fish
        ...
        || is_poetry_subshell
        || ((is_pipenv_subshell || (subshell_initialization_info.is_some() && cfg!(windows)))
