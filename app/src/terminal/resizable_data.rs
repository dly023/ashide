...
pub const DEFAULT_AI_ASSISTANT_WIDTH: f32 = 410.;
pub const DEFAULT_VOLTRON_WIDTH: f32 = 700.;
pub const DEFAULT_LOCAL_DRIVE_INDEX_WIDTH: f32 = 300.;
...
pub struct ModalSizes {
    ...
    pub local_drive_index_width: ResizableStateHandle,
...
impl ModalSizes {
    ...
    pub fn from_restored(
        ...
        let warp_ai_width = window_snapshot
            .warp_ai_width
            .unwrap_or(DEFAULT_AI_ASSISTANT_WIDTH);
        let voltron_width = window_snapshot
            .voltron_width
            .unwrap_or(DEFAULT_VOLTRON_WIDTH);
        let local_drive_index_width = window_snapshot
            .local_drive_index_width
            .unwrap_or(DEFAULT_LOCAL_DRIVE_INDEX_WIDTH);
        ...
        Self {
            ...
            local_drive_index_width: resizable_state_handle(local_drive_index_width),
    ...
    pub fn default_with_panel_defaults(left_default: f32, right_default: f32) -> Self {
        ModalSizes {
            ...
            warp_ai_width: resizable_state_handle(DEFAULT_AI_ASSISTANT_WIDTH),
            voltron_width: resizable_state_handle(DEFAULT_VOLTRON_WIDTH),
            local_drive_index_width: resizable_state_handle(DEFAULT_LOCAL_DRIVE_INDEX_WIDTH),
    ...
    pub fn get_resizable_state_handle(&self, modal: ModalType) -> ResizableStateHandle {
        match modal {
            ...
            ModalType::AiAssistantWidth => self.warp_ai_width.clone(),
            ModalType::VoltronWidth => self.voltron_width.clone(),
            ModalType::LocalDriveIndexWidth => self.local_drive_index_width.clone(),
