...
define_settings_group!(SessionSettings, settings: [
    ...
    startup_shell_override: StartupShellOverride {
        ...
        description: "The shell to use when Ashide starts up.",
    },
    ...
    honor_ps1: HonorPS1 {
        ...
        description: "Whether to use your shell's PS1 prompt instead of the Ashide prompt.",
    },
    ...
    // Machine-local because `gh` CLI availability is machine-specific.
