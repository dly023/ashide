//! Logic relating to a secondary process which Ashide uses to spawn new shell
//! sessions.
//!
...
//! early during Ashide's initialization, we can be more confident that there are
...
/// between processes, enabling the Ashide application process to communicate
