    ...
    let bytes = hex_encoded_dcs_string(
        r#"{
                ...
                "value": {
                    ...
                    "working_directory": "/Users/andy/project",
                    "codex_home": "/Users/andy/.config/codex-custom",
                    "claude_config_dir": "/Users/andy/.config/claude-custom",
                    "editor": "vim",
                    "aliases": "vi=nvim\nvim=nvim",
        ...
        DProtoHook::Bootstrapped { value } => assert_eq!(
            **value,
            BootstrappedValue {
                ...
                working_directory: Some("/Users/andy/project".to_string()),
                codex_home: Some("/Users/andy/.config/codex-custom".to_string()),
                claude_config_dir: Some("/Users/andy/.config/claude-custom".to_string()),
