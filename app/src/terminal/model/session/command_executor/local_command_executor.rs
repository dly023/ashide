...
pub struct LocalCommandExecutionContext {
    pub working_directory: Option<PathBuf>,
    pub environment_variables: HashMap<String, String>,
    pub authoritative_environment_variable_names: HashSet<String>,
}
...
pub struct LocalCommandExecutor {
    ...
    shell_type: ShellType,
    execution_context: LocalCommandExecutionContext,
...
impl LocalCommandExecutor {
    ...
    async fn execute_local_command_internal(
        ...
        for name in &self
            .execution_context
            .authoritative_environment_variable_names
        {
            command_process.env_remove(name);
        }
        command_process.envs(&self.execution_context.environment_variables);
        ...
        // user opened Ashide through a parent process that didn't have the PATH var set
        ...
        } else if let Some(working_directory) = &self.execution_context.working_directory {
