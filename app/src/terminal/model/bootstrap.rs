...
pub enum BootstrapStage {
    /// Ashide is re-parsing historical blocks for this session. We haven't yet started
    /// bootstrapping.
    RestoreBlocks,
    /// Ashide is writing the bootstrap script into the running shell.
    WarpInput,
    /// Execution of any shell startup scripts such as .rc or .profile files.
    ScriptExecution,
    /// Model is fully bootstrapped (i.e the `Bootstrap` message was successfully received by Ashide).   
    Bootstrapped,
