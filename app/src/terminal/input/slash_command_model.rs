...
use crate::ai::skills::environment_skill_inventory::active_terminal_session_skill_inventory;
...
impl SlashCommandModel {
    ...
    fn detect_skill_command(&self, buffer: &str, ctx: &AppContext) -> Option<DetectedSkillCommand> {
        ...
        let matched_skill = active_terminal_session_skill_inventory(active_session, ctx)
            .into_skills()
            .into_iter()
