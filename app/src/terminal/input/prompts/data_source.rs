...
use crate::search::command_palette::local_drive;
...
impl PromptsMenuDataSource {
    pub fn new(ctx: &mut ModelContext<Self>) -> Self {
        ...
        let local_drive_data_source = ctx.add_model(local_drive::DataSource::new_fuzzy);
        Self {
...
impl SyncDataSource for PromptsMenuDataSource {
    ...
    fn run_query(
        ...
        if query_text.is_empty() {
            ...
            return Ok(object_store_workflows
