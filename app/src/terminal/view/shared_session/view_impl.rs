...
use crate::terminal::shared_session::{
    selections::point_to_session_sharing, SharedSessionScrollbackType, SharedSessionStatus,
};
...
impl TerminalView {
    ...
    pub fn on_session_share_started(
        ...
        self.insert_shared_session_started_banner(scrollback_type, false, started_at, ctx);
