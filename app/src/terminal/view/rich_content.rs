...
use crate::{
    ...
    terminal::{
        ...
        view::{
            ...
            environment_runtime_failed_banner::EnvironmentRuntimeFailedBanner,
            environment_runtime_setup_choice_view::EnvironmentRuntimeSetupChoiceView,
        },
...
pub enum RichContentMetadata {
    ...
    EnvironmentRuntimeSetupChoiceBlock {
        handle: ViewHandle<EnvironmentRuntimeSetupChoiceView>,
    },
    EnvironmentRuntimeFailedBanner {
        handle: ViewHandle<EnvironmentRuntimeFailedBanner>,
    },
    WarpifySuccessBlock {
