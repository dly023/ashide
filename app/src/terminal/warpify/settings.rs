...
maybe_define_setting!(EnableSshWarpification, group: WarpifySettings, {
    ...
    description: "Whether to enable Ashide features in SSH sessions.",
});
...
/// Controls how Ashide handles the SSH extension (remote server binary) when connecting
...
pub enum SshExtensionInstallMode {
    ...
    AlwaysAsk,
    /// Automatically install and connect without prompting (default for explicit SSH connects).
    #[default]
    AlwaysInstall,
...
lazy_static! {
    ...
    static ref SUBSHELL_COMMAND_REGEXES: Vec<Regex> = vec![
        ...
        // https://github.com/dly023/ashide/issues/2736
