...
/// WARNING: Don't use this function for use cases dependent on the session, e.g. an Environment Runtime session or WSL on Windows. It only considers this specific host.
