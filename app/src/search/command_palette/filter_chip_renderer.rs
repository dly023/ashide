...
impl FilterChipRenderer for QueryFilter {
    ...
    fn icon_color(&self, appearance: &Appearance) -> ColorU {
        match self {
            ...
            | QueryFilter::Rules
            | QueryFilter::Repos
            | QueryFilter::EnvironmentProviders
            ...
            QueryFilter::Conversations | QueryFilter::HistoricalConversations => appearance
                ...
                .main_text_color(appearance.theme().surface_2())
                .into_solid(),
            QueryFilter::Workflows => local_drive_icon_color(appearance, DriveObjectType::Workflow),
            QueryFilter::Notebooks => local_drive_icon_color(
                appearance,
                DriveObjectType::Notebook {
                    is_ai_document: false,
                },
            ),
            QueryFilter::Plans => local_drive_icon_color(
                appearance,
                DriveObjectType::Notebook {
                    is_ai_document: true,
                },
            ...
            QueryFilter::EnvironmentVariables => {
                local_drive_icon_color(appearance, DriveObjectType::EnvVarCollection)
            }
