...
impl ConversationSearchItem {
    ...
    pub fn render_new_conversation_action_item(
        ...
        Flex::row()
            .with_child(
                Text::new_inline(
                    crate::t!("command-palette-conversations-new-conversation"),
...
impl SearchItem for ConversationSearchItem {
    ...
    fn accessibility_label(&self) -> String {
        match &self.action_info {
            ConversationAction::Resume(matched_conversation) => {
                let fallback_title = crate::t!("conversation-fallback-title");
            ...
            ConversationAction::New => crate::t!("command-palette-conversations-new-conversation"),
        }
    }
