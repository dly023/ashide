...
use crate::drive::local_drive_object_styling::local_drive_icon_color;
...
/// Search item result for a local EnvVarCollection.
#[derive(Debug)]
pub struct EnvVarCollectionSearchItem {
    pub match_result: FuzzyMatchEnvVarCollectionResult,
    pub local_env_var_collection: EnvVarCollectionObject,
}
...
impl SearchItem for EnvVarCollectionSearchItem {
    ...
    fn render_icon(
        ...
        let color = local_drive_icon_color(appearance, DriveObjectType::EnvVarCollection);
    ...
    fn render_item(
        ...
        let mut breadcrumbs_text: Text = Text::new_inline(
            self.local_env_var_collection.breadcrumbs(app),
            appearance.ui_font_family(),
            appearance.monospace_font_size() - 2.,
        )
        .with_color(highlight_state.sub_text_fill(appearance).into_solid());
    ...
    fn accept_result(&self) -> Self::Action {
        CommandPaletteItemAction::InvokeEnvironmentVariables {
            id: self.local_env_var_collection.id,
        }
    }
    ...
    fn execute_result(&self) -> Self::Action {
        CommandPaletteItemAction::ViewInLocalDrive {
            id: ObjectTypeAndId::GenericStringObject {
                object_type: crate::object_store::GenericStringObjectFormat::Json(
                    crate::object_store::JsonObjectType::EnvVarCollection,
                ),
                id: self.local_env_var_collection.id,
            },
        }
