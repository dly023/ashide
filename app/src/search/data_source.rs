...
lazy_static! {
    ...
    static ref ENVIRONMENT_PROVIDERS_FILTER_ATOM: FilterAtom = FilterAtom {
        primary_text: "env:",
        aliases: vec!["provider:"]
    };
...
pub enum QueryFilter {
    ...
    /// Filter for objects in Ashide Drive
    Drive,
    ...
    /// Filter results for Environment provider targets.
...
impl QueryFilter {
    ...
    pub fn filter_atom(&self) -> &'static FilterAtom {
        match self {
            ...
            QueryFilter::EnvironmentProviders => &ENVIRONMENT_PROVIDERS_FILTER_ATOM,
    ...
    pub fn display_name(&self) -> String {
        match self {
            ...
            QueryFilter::EnvironmentProviders => {
                crate::t!("search-filter-display-environment-providers")
            }
    ...
    pub fn icon_svg_path(&self) -> Option<&'static str> {
        match self {
            ...
            QueryFilter::EnvironmentProviders => Some("bundled/svg/key.svg"),
