...
workspace-coding-agent-actions = 编码智能体…
workspace-agent-actions = 智能体操作…
...
settings-ai-discover-agent-sessions = 发现 { $agent } 会话
settings-ai-discover-agent-sessions-description = 发现原生会话，并显示对应的新建会话入口。
...
settings-features-new-tab-placement-all = 在所有环境标签之后
settings-features-new-tab-placement-current = 在当前环境标签之后
...
settings-features-new-tab-placement = 新环境标签位置
...
settings-appearance-category-session-navigator = 会话导航器
...
settings-appearance-tab-show-vertical-panel-in-restored-windows-label = 恢复窗口时显示会话导航器
settings-appearance-tab-show-vertical-panel-in-restored-windows-description = 启用后，重新打开或恢复窗口时会展开会话导航器，即使上次保存时该面板是关闭的。
settings-appearance-tab-show-title-bar-search-bar-label = 在标题栏显示搜索框
settings-appearance-tab-show-title-bar-search-bar-description = 在标题栏中央显示「搜索会话、智能体、文件...」搜索框，点击打开命令面板。关闭后该位置留空。
workspace-title-bar-search-placeholder = 搜索会话、智能体、文件...
settings-appearance-tab-use-prompt-as-title-label = 使用最近的用户提示作为会话标题
settings-appearance-tab-use-prompt-as-title-description = 在会话导航器中，对内置 AI 与第三方 agent 会话显示最近的用户提示，而不是生成的对话标题。
settings-appearance-tab-toolbar-layout-label = 标题栏工具条布局
settings-appearance-tab-toolbar-layout-description = 可把会话导航、环境切换、工具面板等按钮放在标题栏左侧或右侧。
settings-appearance-tab-directory-colors-label = 目录会话颜色
settings-appearance-tab-directory-colors-description = 根据当前目录或仓库自动为会话导航器中的行着色。
settings-appearance-tab-directory-color-default-tooltip = 默认（无颜色）
settings-appearance-zen-mode-label = 显示环境条
settings-appearance-zen-keybinding-always-show = 始终显示环境条
settings-appearance-zen-keybinding-hide-fullscreen = 全屏时隐藏环境条
settings-appearance-zen-keybinding-on-hover = 仅悬停时显示环境条
...
toggle-suffix-show-session-navigator-in-restored-windows = 恢复窗口时显示会话导航器
...
workspace-session-navigator-split-group-badge = 组{ $number }
...
workspace-session-navigator-menu-rename-pane = 重命名面板…
workspace-session-navigator-menu-reset-pane-name = 重置面板名称
...
workspace-session-navigator-menu-close-conversation = 关闭对话
workspace-session-navigator-menu-delete = 永久删除…
...
workspace-environment-provider-picker-refresh = 刷新 SSH 目标
workspace-environment-provider-picker-refreshing = 正在刷新 SSH 目标…
workspace-environment-provider-picker-refresh-error = 刷新失败：{ $message }
...
server-file-browser-search-placeholder = 搜索文件…
...
server-file-browser-filtered-empty = 此目录仅包含隐藏项。显示隐藏文件后即可查看。
server-file-browser-refresh = 刷新文件
server-file-browser-show-hidden-files = 显示隐藏文件
server-file-browser-hide-hidden-files = 隐藏隐藏文件
server-file-browser-upload-files = 上传文件
server-file-browser-upload-folder = 上传文件夹
...
file-browser-broken-symlink = 此符号链接已损坏（目标不存在）。
file-browser-unsupported-symlink = 无法打开此符号链接：目标类型不受支持，或展开后会形成目录循环。
server-file-browser-copied-path = 路径已复制。
server-file-browser-copied-relative-path = 相对路径已复制。
...
server-file-browser-menu-copy-relative-path = 复制相对路径
server-file-browser-menu-cd-to-terminal = 执行 CD 到终端
server-file-browser-menu-open-in-terminal-tab = 在新终端标签页打开
server-file-browser-menu-copy-filename = 复制文件名
server-file-browser-menu-rename = 重命名
server-file-browser-menu-delete = 删除
server-file-browser-menu-open = 打开
server-file-browser-menu-reveal = 在文件管理器中显示
server-file-browser-menu-open-with-default-app = 用默认应用打开
server-file-browser-reveal-ok = 已在文件管理器中显示。
server-file-browser-reveal-failed = 无法打开文件管理器。
server-file-browser-open-failed = 无法打开文件。
...
server-file-browser-transfer-symlink-unsupported = 无法在不保留链接身份的情况下传输符号链接：{ $path }
...
workspace-delete-session-dialog-title-live = 永久删除“{ $title }”？
workspace-delete-session-dialog-message-live = 这将永久删除该逻辑会话的本地记录。若该会话仍在本窗口中打开，其面板或标签页也会一并关闭。此操作无法撤销。
workspace-delete-session-dialog-confirm-live = 永久删除
