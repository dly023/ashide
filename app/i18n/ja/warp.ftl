...
workspace-coding-agent-actions = コーディングエージェント…
workspace-agent-actions = エージェント操作…
...
settings-ai-discover-agent-sessions = { $agent } のセッションを検出
settings-ai-discover-agent-sessions-description = ネイティブセッションを検出し、対応する新規セッション項目を表示します。
...
settings-features-new-tab-placement-all = すべての環境タブの後ろ
settings-features-new-tab-placement-current = 現在の環境タブの後ろ
...
settings-features-new-tab-placement = 新しい環境タブの配置
...
settings-appearance-category-session-navigator = セッションナビゲーター
...
settings-appearance-tab-show-vertical-panel-in-restored-windows-label = 復元されたウィンドウでセッションナビゲーターを表示
settings-appearance-tab-show-vertical-panel-in-restored-windows-description = 有効にすると、ウィンドウの再オープン・復元時に、最後の保存時にセッションナビゲーターが閉じていても開いて表示します。
settings-appearance-tab-show-title-bar-search-bar-label = タイトルバーに検索バーを表示
settings-appearance-tab-show-title-bar-search-bar-description = タイトルバー中央に「セッション、エージェント、ファイルを検索…」検索バーを表示します。クリックでコマンドパレットが開きます。無効化するとスロットが空になります。
settings-appearance-tab-use-prompt-as-title-label = 最新のユーザープロンプトをセッションタイトルとして使用
settings-appearance-tab-use-prompt-as-title-description = セッションナビゲーターで、ビルトイン AI およびサードパーティエージェントセッションに生成された会話タイトルの代わりに最新のユーザープロンプトを表示します。
settings-appearance-tab-toolbar-layout-label = ヘッダーツールバーレイアウト
settings-appearance-tab-toolbar-layout-description = タブパネル、環境、ツールパネルなどのヘッダー操作を左右に配置できます。
settings-appearance-tab-directory-colors-label = ディレクトリセッションの色
settings-appearance-tab-directory-colors-description = 作業中のディレクトリやリポジトリに基づいてセッションナビゲーターの行を自動的に色分けします。
settings-appearance-tab-directory-color-default-tooltip = 既定 (色なし)
settings-appearance-zen-mode-label = 環境ストリップを表示
settings-appearance-zen-keybinding-always-show = 環境ストリップを常に表示
settings-appearance-zen-keybinding-hide-fullscreen = 全画面時に環境ストリップを非表示
settings-appearance-zen-keybinding-on-hover = ホバー時のみ環境ストリップを表示
...
toggle-suffix-show-session-navigator-in-restored-windows = 復元されたウィンドウでセッションナビゲーターを表示
...
workspace-session-navigator-split-group-badge = グループ{ $number }
...
workspace-session-navigator-menu-rename-pane = ペイン名を変更…
workspace-session-navigator-menu-reset-pane-name = ペイン名をリセット
...
workspace-session-navigator-menu-close-conversation = 会話を閉じる
...
workspace-environment-provider-picker-refresh = SSH ターゲットを更新
workspace-environment-provider-picker-refreshing = SSH ターゲットを更新中…
workspace-environment-provider-picker-refresh-error = 更新に失敗しました: { $message }
...
workspace-session-activate-wrong-environment = このセッションは { $environment } に属しています。復元する前にその環境に切り替えてください。
...
server-file-browser-filtered-empty = このディレクトリには非表示の項目のみがあります。表示するには隠しファイルを表示してください。
server-file-browser-refresh = ファイルを更新
server-file-browser-show-hidden-files = 隠しファイルを表示
server-file-browser-hide-hidden-files = 隠しファイルを非表示
server-file-browser-upload-files = ファイルをアップロード
server-file-browser-upload-folder = フォルダーをアップロード
...
workspace-delete-session-dialog-title-live = “{ $title }”を完全に削除しますか？
workspace-delete-session-dialog-message-live = この論理セッションのローカル記録を完全に削除します。まだこのウィンドウで開いている場合は、ペインまたはタブも閉じられます。この操作は元に戻せません。
workspace-delete-session-dialog-confirm-live = 完全に削除
