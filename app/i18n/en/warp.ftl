...
workspace-coding-agent-actions = Coding Agents…
workspace-agent-actions = Agent actions…
...
settings-ai-discover-agent-sessions = Discover { $agent } sessions
settings-ai-discover-agent-sessions-description = Discover native sessions and show matching New Session entries.
...
settings-features-new-tab-placement-all = After all environment tabs
settings-features-new-tab-placement-current = After current environment tab
...
settings-features-new-tab-placement = New environment tab placement
...
settings-appearance-category-session-navigator = Session Navigator
...
settings-appearance-tab-show-title-bar-search-bar-description = Show the "Search sessions, agents, files…" search bar in the middle of the title bar; click to open the command palette. Disable to leave the slot empty.
workspace-title-bar-search-placeholder = Search sessions, agents, files...
settings-appearance-tab-use-prompt-as-title-label = Use latest user prompt as session title
...
settings-appearance-tab-toolbar-layout-description = Place Tabs Panel, Environment, Tools Panel, and other header controls on the left or right.
settings-appearance-tab-directory-colors-label = Directory session colors
settings-appearance-tab-directory-colors-description = Automatically color Session Navigator rows based on the directory or repo you're working in.
settings-appearance-tab-directory-color-default-tooltip = Default (no color)
settings-appearance-zen-mode-label = Show the environment strip
settings-appearance-zen-keybinding-always-show = Always show environment strip
settings-appearance-zen-keybinding-hide-fullscreen = Hide environment strip when fullscreen
settings-appearance-zen-keybinding-on-hover = Only show environment strip on hover
...
toggle-suffix-show-session-navigator-in-restored-windows = show Session Navigator in restored windows
...
workspace-session-navigator-split-group-badge = group { $number }
...
workspace-session-navigator-menu-rename-pane = Rename pane…
workspace-session-navigator-menu-reset-pane-name = Reset pane name
...
workspace-session-navigator-menu-close-conversation = Close conversation
...
workspace-environment-provider-picker-refresh = Refresh SSH targets
workspace-environment-provider-picker-refreshing = Refreshing SSH targets…
workspace-environment-provider-picker-refresh-error = Refresh failed: { $message }
...
workspace-session-activate-wrong-environment = This session belongs to { $environment }. Switch to that environment before restoring it.
...
server-file-browser-search-placeholder = Search files…
...
server-file-browser-filtered-empty = This directory contains only hidden entries. Show hidden files to view them.
server-file-browser-refresh = Refresh files
server-file-browser-show-hidden-files = Show hidden files
server-file-browser-hide-hidden-files = Hide hidden files
server-file-browser-upload-files = Upload files
server-file-browser-upload-folder = Upload folder
...
file-browser-broken-symlink = This symbolic link is broken (its target is missing).
file-browser-unsupported-symlink = This symbolic link cannot be opened because its target type is unsupported or it would create a directory cycle.
server-file-browser-copied-path = Path copied.
server-file-browser-copied-relative-path = Relative path copied.
...
server-file-browser-menu-copy-relative-path = Copy relative path
server-file-browser-menu-cd-to-terminal = Run cd in terminal
server-file-browser-menu-open-in-terminal-tab = Open in terminal tab
...
server-file-browser-menu-open = Open
server-file-browser-menu-reveal = Reveal in file manager
server-file-browser-menu-open-with-default-app = Open with default app
server-file-browser-reveal-ok = Revealed in file manager.
server-file-browser-reveal-failed = Could not open file manager.
server-file-browser-open-failed = Could not open file.
...
server-file-browser-transfer-symlink-unsupported = Symbolic links cannot be transferred without preserving link identity: { $path }
...
workspace-delete-session-dialog-title-live = Delete “{ $title }” permanently?
workspace-delete-session-dialog-message-live = This permanently deletes local session records for this logical session. If it is still open in this window, its pane or tab will also be closed. It cannot be undone.
workspace-delete-session-dialog-confirm-live = Delete permanently
