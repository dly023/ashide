Implements a dock tile plugin for Ashide.
...
The plugin is installed into the app bundle at `Contents/PlugIns/AshideDockTilePlugin.docktileplugin` and is bundled using the script/macos/bundle script.  It is built as a universal binary for both arm64 and x86_64.
